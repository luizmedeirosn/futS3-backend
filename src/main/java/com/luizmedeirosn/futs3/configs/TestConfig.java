...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        gameModeRepository.saveAll(Arrays.asList(gm1, gm2, gm3 ,gm4, gm5, gm6, gm7, gm8, gm9));
        ...
        positionRepository.saveAll(Arrays.asList(pos1, pos2, pos3 ,pos4, pos5, pos6, pos7, pos8, pos9, pos10, pos11, pos12, pos13, pos14, pos15));
        ...
        Parameter prmt24 = new Parameter(   "FINALIZAÇÃO",                      null );
        Parameter prmt25 = new Parameter(   "VELOCIDADE",                       null );

        parameterRepository.saveAll(
            Arrays.asList(prmt1, prmt2, prmt3 ,prmt4, prmt5, prmt6, prmt7, prmt8, prmt9, prmt10, prmt11, prmt12, prmt13, prmt14, prmt15, prmt16, prmt17, prmt18, prmt19, prmt20, prmt21, prmt21, prmt22, prmt23, prmt24, prmt25)
        );
        ...
        playerRepository.saveAll(
            Arrays.asList(player1, player2, player3 ,player4, player5, player6, player7, player8, player9, player10, player11, player12, player13, player14, player15, player16, player17, player18, player19, player20, player21, player21, player22, player23, player24, player25, player26, player27, player28, player29, player30, player31, player32)
        );

        PositionParameter pp1 = new PositionParameter(  pos11, prmt15, 100 );
        PositionParameter pp2 = new PositionParameter(  pos12, prmt12, 25 );
        PositionParameter pp3 = new PositionParameter(  pos12, prmt14, 25 );
        PositionParameter pp4 = new PositionParameter(  pos12, prmt25, 50 );
        PositionParameter pp5 = new PositionParameter(  pos13, prmt14, 20 );
        PositionParameter pp6 = new PositionParameter(  pos13, prmt23, 30 );
        PositionParameter pp7 = new PositionParameter(  pos13, prmt25, 50 );
        PositionParameter pp8 = new PositionParameter(  pos15, prmt12, 20 );
        PositionParameter pp9 = new PositionParameter(  pos15, prmt19, 20 );
        PositionParameter pp10 = new PositionParameter( pos15, prmt25, 60 );

        positionParameterRepository.saveAll(Arrays.asList(pp1, pp2, pp3, pp4, pp5, pp6, pp7, pp8, pp9, pp10));

        PlayerParameter pylp1 = new PlayerParameter( player11, prmt10, 50 );
        PlayerParameter pylp2 = new PlayerParameter( player11, prmt17, 60 );
        PlayerParameter pylp3 = new PlayerParameter( player11, prmt15, 77 );
        PlayerParameter pylp4 = new PlayerParameter( player26, prmt12, 50 );
        PlayerParameter pylp5 = new PlayerParameter( player26, prmt19, 80 );
        PlayerParameter pylp6 = new PlayerParameter( player26, prmt25, 32 );

        playerParameterRepository.saveAll(Arrays.asList(pylp1, pylp2, pylp3, pylp4, pylp5, pylp6));
